...
import { ServiceTypeService } from 'src/app/core/services/vehicle-config-services/service-type.service';
  ...
  saveData() {
    ...
    if (this.dataForm.valid) {
      if (this.dataForm.get("id")?.value) {
        ...
        this.serviceTypeService.updateServiceType(newData).subscribe({
        ...
        this.serviceTypeService.addServiceType(newData).subscribe({
          next: (res: ResponseMessage) => {
            if (res.success) {
              this.successAddMessage = res.message;
              this.closeModal();
