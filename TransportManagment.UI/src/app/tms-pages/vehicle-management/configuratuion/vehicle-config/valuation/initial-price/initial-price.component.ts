...
export class InitialPriceComponent {
  ...
  refreshData(){
    this.vehicleConfigService.getAllInitialPrice().subscribe({
      next: (res) => {
        if (res) 
          {
  ...
  saveData() {
    ...
    if (this.dataForm.valid) {
      if (this.dataForm.get("id")?.value) {
        ...
        this.vehicleConfigService.updateInitialPrice(newData).subscribe({
        ...
        this.vehicleConfigService.addInitialPrice(newData).subscribe({
          next: (res: ResponseMessage) => {
            if (res.success) {
              this.successAddMessage = res.message;
              this.closeModal();
