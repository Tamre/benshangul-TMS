...
export class VehicleBodyTypeComponent implements OnInit {
  ...
  getVehicleType(){
    this.vehiclecongigService.getAllVehicleType().subscribe({
      next: (res) => {
        if (res) 
          {
  ...
  saveData() {
    ...
    if (this.dataForm.valid) {
      if (this.dataForm.get("id")?.value) {
        ...
        this.vehiclecongigService.updateVehicleBodyType(newData).subscribe({
        ...
        this.vehiclecongigService.addVehicleBodyType(newData).subscribe({
          next: (res: ResponseMessage) => {
            if (res.success) {
              this.successAddMessage = res.message;
              this.closeModal();
