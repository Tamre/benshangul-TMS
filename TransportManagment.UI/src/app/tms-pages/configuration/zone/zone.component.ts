...
export class ZoneComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dataForm = this.formBuilder.group({
      ...
      seffix: ["", [Validators.required]],
      localSuffix: ["", [Validators.required]],
  ...
  openModal(content: any) {
    ...
    this.dataForm.controls["regionName"].setValue("");
  ...
  saveData() {
    ...
    if (this.dataForm.valid) {
      if (this.dataForm.get("id")?.value) {
        const newData: Zone = this.dataForm.value;
        this.addressService.updateZone(newData).subscribe({
          next: (res) => {
            if (res.success) {
        ...
        this.addressService.addZone(newData).subscribe({
          next: (res) => {
            if (res.success) {   
              this.closeModal();
              successToast(res.message);
  ...
  editDataGet(id: any, content: any) {
    ...
    this.translate.get("Edit Zone").subscribe((res: string) => {
    ...
    this.dataForm.controls["regionId"].setValue(this.econtent.regionId);
    ...
    this.dataForm.controls["seffix"].setValue(
      this.econtent.seffix
    );
    this.dataForm.controls["localSuffix"].setValue(
      this.econtent.localSuffix
    );
    this.dataForm.controls["isCity"].setValue(
      this.econtent.isCity
    );
    this.dataForm.controls["createdById"].setValue(this.currentUser?.userId);
